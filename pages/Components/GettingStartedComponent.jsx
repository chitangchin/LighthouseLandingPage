export default function GettingStarted() {
  return <div id="GettingStartedComponent">
    ...
    There are just a few steps that need to be completed before being able to visualize all your data!
      ...
      <a id="link1" onClick={()=> {window.open("https://docs.confluent.io/confluent-cli/current/command-reference/kafka/cluster/index.html#confluent-kafka-cluster", '_blank')}}>
      Setting up a Confluent Kafka Cluster
      </a>
      <a id="link2" onClick={()=> {window.open("https://prometheus.io/docs/prometheus/latest/getting_started/", '_blank')}}>
